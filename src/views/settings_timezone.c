...
void view_settings_timezone_setup(void)
{
    ...
    pool_create_text(&view, "text0", "area0", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text1", "area1", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text2", "area2", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text3", "area3", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text4", "area4", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text5", "area5", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text6", "area6", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text7", "area7", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text8", "area8", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text9", "area9", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text10", "area10", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text11", "area11", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text12", "area12", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text13", "area13", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text14", "area14", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
    pool_create_text(&view, "text15", "area15", TEXT_TYPE_SELECT, TEXT_ALIGN_LEFT, 0);
