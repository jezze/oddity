...
void view_front_setup(void)
{
    ...
    pool_create_area(&view, "area_library", WIDGET_IN_DEFAULT, 0, 5, 12, 1);
    pool_create_area(&view, "area_settings", WIDGET_IN_DEFAULT, 0, 6, 12, 1);
    pool_create_area(&view, "area_exit", WIDGET_IN_DEFAULT, 0, 7, 12, 1);
