...
void view_settings_setup(void)
{
    ...
    widget_area_init(view_createwidget(&view), "area_network", WIDGET_IN_DEFAULT, 0, 4, 4, 3);
    widget_area_init(view_createwidget(&view), "area_network_icon", WIDGET_IN_DEFAULT, 0, 4, 4, 2);
    widget_icon_init(view_createwidget(&view), WIDGET_ID_DEFAULT, "area_network_icon", ICON_NETWORK);
    widget_area_init(view_createwidget(&view), "area_network_text", WIDGET_IN_DEFAULT, 0, 6, 4, 1);
    widget_text_init(view_createwidget(&view), WIDGET_ID_DEFAULT, "area_network_text", TEXT_COLOR_SELECT, TEXT_ALIGN_CENTER, "Network");
    widget_area_init(view_createwidget(&view), "area_system", WIDGET_IN_DEFAULT, 4, 4, 4, 3);
    widget_area_init(view_createwidget(&view), "area_system_icon", WIDGET_IN_DEFAULT, 4, 4, 4, 2);
    widget_icon_init(view_createwidget(&view), WIDGET_ID_DEFAULT, "area_system_icon", ICON_SYSTEM);
    widget_area_init(view_createwidget(&view), "area_system_text", WIDGET_IN_DEFAULT, 4, 6, 4, 1);
